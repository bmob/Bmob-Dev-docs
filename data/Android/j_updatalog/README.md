...
3. 修复调用云函数（callEndpoint）方法的成功回调的返回值中含有“results”的问题；
...
v3.2.5   2014年10月27日
1. 修复SDK调用云函数出现ArrayIndexOutOfBoundsException(对应的错误码为9015)的问题；
