...
<table>
	<tr>
        <td colspan=3 align=center>电影表（Movie表）</td>
    </tr>
    <tr>
        <td>字段名</td><td>类型</td><td>描述</td>
    </tr>
	<tr>
        <td>name</td><td>String</td><td>电影名称</td>
    </tr>
	<tr>
        <td>file</td><td>File</td><td>电影文件</td>
    </tr>
</table>
...
<table>
	<tr>
        <td colspan=3 align=center>音乐表（Music表）</td>
    </tr>
    <tr>
        <td>字段名</td><td>类型</td><td>描述</td>
    </tr>
	<tr>
        <td>name</td><td>String</td><td>歌曲名称</td>
    </tr>
	<tr>
        <td>artist</td><td>String</td><td>艺术家</td>
    </tr>
	<tr>
        <td>mp3</td><td>File</td><td>mp3文件</td>
    </tr>
	<tr>
        <td>lrc</td><td>File</td><td>歌词文件</td>
    </tr>
</table>
