短信服务的API集成在BmobSDK中，因此不熟悉的朋友在使用前先可以了解一下BmobSDK的集成[PHP 快速入门](https://docs.bmob.cn/data/PHP/a_faststart/doc/index.html)
...
为了保障短信的下发速度和送达率，[Bmob](https://www.bmob.cn/ "Bmob移动后端云服务平台") 为所有用户申请了一致的独享通道，默认使用 **【比目科技】** 作为签名，且不可更改。
